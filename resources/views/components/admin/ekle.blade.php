      ...
      <div class="row">
        ...
        <div class="col-xl-7 pe-xl--0 ps-xxl-4">
            <div class="add-qustion-widget">
                <h4 class="widget-title">Etiket Ekle</h4>
                <form action="{{route('etiketler.store')}}" method="POST">
                    @csrf
                    <div class="mt-30">
                        <label for="inp-nam" class="label">Name<span>*</span></label>
                        <div class="icon-input-group">
                            <input type="text" class="form-control" id="inp_nam" name="name" value="{{old('name')}}">

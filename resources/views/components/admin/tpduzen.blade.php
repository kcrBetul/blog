      ...
      <div class="row">
        ...
        <div class="col-xl-7 pe-xl-0 ps-xxl-4">
            <div class="add-question-widget">
                ...
                <form action="{{route('konular.update',$konu->id)}}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="mt-30">
                        <label for="in-title" class="label">Title <span>*</span></label>
                        <div class="icon-input-group">
                            <input type="text" class="form-control" name="title" value="{{$konu->title}}">
                    ...
                    <div class="mt-25">
                        <label for="inp_category" class="label">User_Id<span>*</span></label>
                        <div class="icon-input-group">
                            <input type="text" name="user_id" id="inp_sur" class="form-control" value="{{$konu->user_id}}">
                    ...
                    <div class="mt-25">
                        <label for="inp_tag" class="label">Ticket_Id <span>*</span></label>
                        <div class="icon-input-group">
                            <input type="text" name="ticket_id" id="inp_tag" class="form-control" value="{{$konu->ticket_id}}">
                        </div>
                    </div>
                    <div class="mt-25">
                        <label for="inp_desc" class="label">Phone <span>*</span></label>
                        <div class="icon-input-group">
                            <input type="text" name="contents" class="form-control" id="inp_desc" value="{{$konu->contents}}">
                            <i class="icon-tags"></i>
                        </div>
                        <div class="instruction">
                    ...
                    <div class="d-flex justify-content-between mt-60">
                        ...
                        <button class="btn btn-success btn-lg btn-block" type="update">Kaydet</button>
                    </div>
                </form>
            </div>
            </div>

      ...
      <div class="row">
        ...
        <div class="col-xl-7 pe-xl-0 ps-xxl-4">
          <div class="add-question-widget">
            <h4 class="widget-title">Konu Ekle</h4>
            <form action="{{route('konular.store')}}" method="POST">
                @csrf

              <div class="mt-30">
                <label class="label" for="inp_nam">Title<span>*</span></label>
                <div class="icon-input-group">
                  <input class="form-control" type="text" id="inp_nam" name="title" value="{{old('title')}}" />
              ...
              <div class="mt-25">
                <label class="label" for="inp_sur">User_Id <span>*</span></label>
                <div class="icon-input-group">
                    <input class="form-control" type="text" id="inp_sur" name="user_id" value="{{old('user_id')}}" />
                    <i class="icon_chat_alt"></i>
                  </div>
                <div class="instruction">
                  Please choose an appropriate title for the equation so
              ...
              <div class="mt-25">
                <label class="label" for="inp_ticket">Ticket_Id <span>*</span></label>
                <div class="icon-input-group">
                    ...
                    {{-- <input class="form-control" type="text" id="inp_ticket" name="ticket_id" value="{{old('ticket_id')}}" /> --}}
                    <i class="icon_chat_alt"></i>
                  </div>
                <div class="instruction">
                  Please choose an appropriate title for the equation so
              ...
              <div class="mt-25">
                <label class="label" for="inp_pho">Contents<span>*</span></label>
                <div class="icon-input-group">
                    <input class="form-control" type="text" id="inp_pho" name="contents"  value="{{old('contents')}}"/>
                    <i class="icon_tags"></i>
                </div>
                <div class="instruction">
                  Please choose an appropriate title for the equation so

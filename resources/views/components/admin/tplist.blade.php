            ...
            <div class="col-xl-7 col-lg-8">
                <div class="forum_topic_list_inner">
                    ...
                    <div class="forum_l_inner">
                        ...
                        <div class="forum_body">
                            <tbody>
                              ...
                              <tr>
                                <td>{{$konu->title}}</td>
                                <td>{{$konu->user_id}}</td>
                                <td>{{$konu->ticket_id}}</td>
                                <td>{{$konu->contents}}</td>
                                <td>
                                    <a href="{{route('konular.edit',$konu->id)}}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                    <a href="{{route('konular.destroy',$konu->id)}}"  class="btn btn-danger"><i class="fa fa-times"></i></a>
                                </td>
                              </tr>
                              @endforeach
                            </tbody>
                       ...
                       <h5 class="card-title mt-2"> <a href="{{route('konular.create')}}" class="btn btn-sm btn-danger">Konu Ekle</a></h5>
                    </div>
                      {{-- {{$uyeler->links()}} --}}
